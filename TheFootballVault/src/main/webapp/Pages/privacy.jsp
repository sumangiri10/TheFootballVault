  ...
  <main>
    ...
    <header class="policy-header">
        ...
        <div class="breadcrumb">
            <a href="${pageContext.request.contextPath}/Pages/home.jsp">Home</a> > Privacy Policy
        </div>
    </header>
        ...
        <div class="policy-content">
            ...
            <section class="policy-section">
                ...
                <ul>
                    ...
                    <li><strong>Shipping Partners:</strong> Companies that deliver your orders.</li>
                    <li><strong>Payment Processors:</strong> Companies that process your payments.</li>
                </ul>
