...
<header>
    ...
    <nav class="main-nav" id="mainNav">
        ...
        <li class="nav-item tagline-item">
            ...
            <li class="nav-item">
                <a href="${pageContext.request.contextPath}/Pages/home.jsp" class="nav-link">Home</a>
            </li>
            <li class="nav-item dropdown">
                <a href="${pageContext.request.contextPath}/Pages/football.jsp" class="nav-link">
                    Football Jerseys
            ...
            <li class="nav-item">
                <a href="${pageContext.request.contextPath}/Pages/kids.jsp" class="nav-link">Kids Jerseys</a>
            </li>
            <li class="nav-item dropdown">
            <a href="${pageContext.request.contextPath}/Pages/retrojersey.jsp" class="nav-link">
            Retro Jerseys
            <img src="${pageContext.request.contextPath}/Images/menu.png" alt="Expand" class="dropdown-icon">
            </a>
            <ul class="dropdown-menu">
            ...
            <li class="nav-item dropdown">
                <a href="${pageContext.request.contextPath}/Pages/international.jsp" class="nav-link">
            ...
            <li class="nav-item dropdown">
                <a href="${pageContext.request.contextPath}/Pages/boots.jsp" class="nav-link">Boots</a>
            </li>
            <li class="nav-item sale">
                <a href="${pageContext.request.contextPath}/Pages/contact.jsp" class="nav-link">Contact Us</a>
            </li>
            <li class="nav-item sale">
                <a href="${pageContext.request.contextPath}/Pages/about.jsp" class="nav-link">About Us</a>
            </li>
        </ul>
    </nav>
